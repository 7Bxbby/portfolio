    ...
    return (
        <LampContainer>
            <motion.h1
                ...
                className="mt-8 bg-gradient-to-br from-gray-400 to-gray-600 py-4 bg-clip-text text-center text-4xl font-medium tracking-tight text-transparent md:text-7xl"
            >
...
export const LampContainer = ({
    ...
    return (
        <div
            className={cn(
                "relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-black w-full rounded-md z-0", // background black
                className
            )}
        >
