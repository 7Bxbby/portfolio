...
`}</style>
        ...
        text-center
          ...
          ${isMoving ? "opacity-0 scale-95 translate-y-4 pointer-events-none duration-100" : "opacity-100 scale-100 translate-y-0 pointer-events-auto duration-500"}
        `}
                    >
                        {activeItem.title}
                        <span className={"block text-sm text-gray-400 select-none"}><br/>Grab to change project!</span>
                    </h2>
